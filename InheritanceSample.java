public class InheritanceSample
{
	public static void main(String[] args) {
		Student student1 = new Student("Maricar", " Brgy. Camastilisan, Calaca City, Batangas", "BSIT", 2);
		...
		Staff staff1 = new Staff("Jesusa Marie", "Brgy.Camastilisan, Calaca City, Batangas", "Batangas State University", 500.00f );
